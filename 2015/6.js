...
// const grid = new Array(1000).fill(new Array(1000).fill(0));
// 👆 Need to create grid manually, creating it with fill doesn't work for some reason 🤷‍♂️
const grid1 = [];
const grid2 = [];
...
input.forEach((input) => {
  let command = input.match(/(turn on|turn off|toggle)/)[0];
  let [xStart, yStart, xEnd, yEnd] = input.match(/[0-9]+/g);
...
console.log("Answer 1: ", litLights);
console.log("Answer 2: ", totalBrightness);
